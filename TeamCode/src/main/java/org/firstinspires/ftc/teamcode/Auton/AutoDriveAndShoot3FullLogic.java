...
public class AutoDriveAndShoot3FullLogic extends OpMode {
    ...
    private void updateRPMLED() {
        ...
        double targetRPM = (m3.getVelocity() / TICKS_PER_REV) * 60.0; // In auto, we can check against actual target if needed
        double rpmError = Math.abs(3200 - currentRPM); // Using 3200 as target
