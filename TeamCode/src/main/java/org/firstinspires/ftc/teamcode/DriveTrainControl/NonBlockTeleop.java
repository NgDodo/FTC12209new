...
public class NonBlockTeleop extends OpMode {
    ...
    /**
     * Non-blocking sorter movement update - runs every loop
     */
    private void updateSorterMovement() {
        ...
        // Check if we're within perfect tolerance
    ...
    /**
     * Start a non-blocking sorter movement
     */
