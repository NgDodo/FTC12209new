...
@Configurable
public class PreloadFarShooterAuton extends OpMode {
    ...
    // === TUNABLE PARAMETERS ===
    private static final double SHOOTING_RPM = 2800;
    private static final double SPINUP_TIME = 4.5; // Seconds to wait for flywheel
    private static final double SHOOT_DURATION = 2; // How long to keep shooter active
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(87.5, 8.25, Math.toRadians(90)));

        // === Build paths ===
        Path1 = follower
                .pathBuilder()
                .addPath(new BezierLine(new Pose(87.5, 8.25), new Pose(87.5, 12)))
                .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(70))
                .build();

        Path2 = follower
                .pathBuilder()
                .addPath(new BezierLine(new Pose(87.5, 8.25), new Pose(105, 12)))
