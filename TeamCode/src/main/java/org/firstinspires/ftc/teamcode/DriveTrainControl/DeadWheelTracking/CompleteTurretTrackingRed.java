...
@TeleOp(name = "Complete Turret Tracking [Red]", group = "DriveTrainControl")
public class CompleteTurretTrackingRed extends OpMode {
    ...
    @Override
    public void init() {
        startingPose = new Pose(123.1, 123.1, Math.toRadians(0));
    ...
    public void loop() {
        ...
        Pose GOAL_POST = new Pose(134, 134, 36);
