...
@Autonomous(name = "RedCloseLeave", group = "Autonomous")
@Configurable
public class RedCloseLeave extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(123.1, 123.1, Math.toRadians(37)));
