...
@Autonomous(name = "TurretCloseRed", group = "Autonomous")
@Configurable
public class CloseRed extends OpMode {
    ...
    private void buildPaths() {
        ...
        Path3 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(95.000, 82.000), new Pose(103.5, 82.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();

        Path4 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(103.5, 82.000), new Pose(103.000, 82.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();

        Path5 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(103.000, 82.000), new Pose(107.5, 82.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        Path10 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(95, 58.000), new Pose(103.5, 58.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();

        Path11 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(103.50, 58.000), new Pose(103, 58.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();

        Path12 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(103, 58.000), new Pose(107.50, 58.000)))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
