...
@TeleOp(name="LimeLight x Position Tracking", group="DriveTrainControl")
public class LimeLightXPositionTracking extends OpMode {
            ...
            for (LLResultTypes.FiducialResult fiducial : fiducials) {
                if (fiducial.getFiducialId() == 20) {
                    ...
                    if (Math.abs(bearing) > 2) { //
                        ///TODO: Set some proportional power to motor (1/distance?)
                        m2.setPower(turretRotatePower); // arbitrary 67
